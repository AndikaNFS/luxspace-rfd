...
function Carousel({ children, refContainer}) {
    ...
    useLayoutEffect(() => {
      ...
      refForwardDragHandler.addEventListener("touchsend", onDragEnd)
      refForwardDragHandler.addEventListener("touchmove", onDragMove )
      refForwardDragHandler.addEventListener("click", onDragMove )
      ...
      return () => {
        ...
        refForwardDragHandler.removeEventListener("touchsend", onDragEnd)
        refForwardDragHandler.removeEventListener("touchmove", onDragMove )
        refForwardDragHandler.removeEventListener("click", onDragMove )
